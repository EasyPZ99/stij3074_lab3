...
if (isset($_POST["submit"])) {
    ...
    $sqlinsert = "INSERT INTO `tbl_product`(`item_title`, `item_author`, `item_isbn`, `item_price`, `item_description`, `item_pub`, `item_lang`) VALUES ('$title', '$author', '$isbn', $price, '$description', '$publisher', '$langguage')";
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-green w3-xlarge" style="max-width:1200px;margin:auto">
            ...
            <a href="index.php" onclick="w3_close()" class="w3- right w3-bar-item w3-button">Home</a>
            <div class="w3-center w3-padding-16">Afira Herbs</div>
        </div>
    </div>
